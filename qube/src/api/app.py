...
from qube.src.api.kate4controller import kate4Controller
from qube.src.api.kate4controller import kate4ItemController
from qube.src.api.versioncontroller import kate4ItemVersionController
...
api.add_resource(kate4ItemVersionController, '/v1/kate4/version')
api.add_resource(kate4Controller, '/v1/kate4')
api.add_resource(kate4ItemController, '/v1/kate4/<string:entity_id>')
