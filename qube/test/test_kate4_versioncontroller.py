...
HELLO_VERSION = "/v1/kate4/version"
...
class Testkate4VersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_kate4_default_version(self, *args, **kwargs):
    ...
    def test_kate4_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
